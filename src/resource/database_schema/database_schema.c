...
LuaCEmbedResponse * database_schema_add_sub_schema(LuaCEmbedTable *self,LuaCEmbed *args) {
    ...
    DtwDtatabaseSchema *root_sschema = (DtwDtatabaseSchema*)LuaCembedTable_get_long_prop(self,DATABASE_SCHEMA_POINTER);
...
LuaCEmbedTable * raw_create_database_schema(LuaCEmbed *args,DtwDtatabaseSchema *database_schema) {
